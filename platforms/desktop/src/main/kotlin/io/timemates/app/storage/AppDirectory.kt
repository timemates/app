package io.timemates.app.storage

import io.timemates.app.AppConstants
...
val AppDirectory: Path by lazy {
    ...
    when {
        os.contains("win") -> Path(System.getenv("APPDATA") + AppConstants.APP_NAME)
        os.contains("mac") -> Path(System.getProperty("user.home"), "Library/Application Support/${AppConstants.APP_NAME}")
